 ...
 *
 * Managed IAM (this template variant): `HerculesIAM` wraps the route tree
 * inside both providers so it can read the session and Convex auth state. It
 * runs deployment entry once per session after sign-in, turns IAM access
 * errors thrown by Convex functions into the routed `/auth/*` access pages,
 * and toasts permission denials. The impersonation banner sits beside it.
 */
